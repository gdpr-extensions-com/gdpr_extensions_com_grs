...
namespace GdprExtensionsCom\GdprExtensionsComGrs\Tests\Unit\Controller;
...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComGrs\Controller\GdprManagerController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\GdprExtensionsCom\GdprExtensionsComGrs\Controller\GdprManagerController::class))
    ...
    public function listActionFetchesAllGdprManagersFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $gdprManagerRepository = $this->getMockBuilder(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Repository\GdprManagerRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $gdprManager = new \GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager();
