...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $reviwsSliderData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_grs')->toArray();
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function manageAction(): \Psr\Http\Message\ResponseInterface
    {
        $uploadImageUrl = $this->uriBuilder->reset()
            ->uriFor('uploadImage');
        $this->view->assign('uploadImageUrl', $uploadImageUrl);
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComGrs\Domain\Model\GdprManager $gdprManager)
    {
