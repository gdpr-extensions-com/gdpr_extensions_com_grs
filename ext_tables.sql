...
CREATE TABLE tt_content (
	...
	gdpr_color_of_border varchar(255) NOT NULL DEFAULT '',
	gdpr_color_of_text varchar(255) NOT NULL DEFAULT '',
	gdpr_same_as_url varchar(255) NOT NULL DEFAULT '',
	gdpr_alt_text varchar(255) NOT NULL DEFAULT '',
	gdpr_background_color varchar(255) NOT NULL DEFAULT '',
	gdpr_show_all_reviews int(11) NOT NULL DEFAULT '0',
	gdpr_business_locations varchar(255) NOT NULL DEFAULT '',
	tx_gdprreviewsclient_slider_max_reviews int(11) NOT NULL DEFAULT '4',
);
